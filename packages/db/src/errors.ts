...
const conflictConstraints = ['whatsapp_phone_unique','route_manifest_dispatch_once_idx','route_lots_active_idx','route_parcels_active_idx','lot_active_route_guard','lot_memberships_one_active_idx','lots_active_code_idx','parcels_docket_key', 'parcels_docket_reserved', 'memberships_one_active_role_idx', 'invitations_one_pending_role_idx'] as const;
