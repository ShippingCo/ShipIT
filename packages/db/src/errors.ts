...
const conflictConstraints = ['lot_memberships_one_active_idx','lots_active_code_idx','parcels_docket_key', 'parcels_docket_reserved', 'memberships_one_active_role_idx', 'invitations_one_pending_role_idx'] as const;
