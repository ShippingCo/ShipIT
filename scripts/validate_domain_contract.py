...
def validate():
    ...
    rules = {}
    for prefix, count in [("R", 30), ("E", 4), ("W", 45)]:
    ...
    print("Domain contract checks passed: 79 matrix rows including exact W41 lifecycle, W42 membership, W43 pricing override W44 redrive and W45 installation grants plus W29/W34/W35 restrictions, 28 synthetic access/projection plus 21 pricing role/scope cases, 13 closed transition rows/actors, all Booking fields and prototype failure reasons, global fixture dockets, money/date/cancellation/adoption examples. No production behavior tested.")
