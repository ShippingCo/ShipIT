...
export interface RouteScopes {command:TenantAccess; audit:TenantAccess|null; events:TenantAccess|null; revision:string; transit?:TenantAccess|null; parcelEvents?:TenantAccess|null}
