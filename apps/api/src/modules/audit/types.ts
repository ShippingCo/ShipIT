export const resourceTypes = ['whatsapp_installation','outbox_job','eway','attachment','receipt','payment_obligation','route','lot','booking','parcel','organization','franchise','membership','invitation','identity','audit','request','customer','pricing','tax'] as const;
export type ResourceType = typeof resourceTypes[number];
export const denialActions = ['receipts.read','payments.read','payments.collect','payments.reverse','routes.read','routes.list','routes.event','routes.create','routes.update','routes.archive','routes.finalize','routes.lot.attach','routes.lot.detach','routes.parcel.attach','routes.parcel.detach','lots.read','lots.list','lots.create','lots.update','lots.archive','lots.membership.add','lots.membership.move','lots.membership.remove','bookings.create','tax.read','tax.draft','tax.publish','tax.prepare','tax.resolve','tax.calculate','pricing.read','pricing.draft','pricing.publish','pricing.quote','audit.read','membership.manage','invitation.create','invitation.accept','invitation.revoke',
