export const resourceTypes = ['attachment','receipt','payment_obligation','route','lot','booking','parcel','organization','franchise','membership','invitation','identity','audit','request','customer','pricing','tax'] as const;
