export const resourceTypes = ['booking','parcel','organization','franchise','membership','invitation','identity','audit','request','customer','pricing','tax'] as const;
export type ResourceType = typeof resourceTypes[number];
export const denialActions = ['bookings.create','tax.read','tax.draft','tax.publish','tax.prepare','tax.resolve','tax.calculate','pricing.read','pricing.draft','pricing.publish','pricing.quote','audit.read','membership.manage','invitation.create','invitation.accept','invitation.revoke',
