...
try {
  ...
  const secretResolver = developerSecretResolver(config, process.env.LOCAL_DATABASE_URL,process.env.LOCAL_AUTH_JSON,process.env.LOCAL_STORAGE_CREDENTIAL,process.env.LOCAL_WHATSAPP_JSON);
