...
try {
  ...
  const resolver=developerSecretResolver(config,process.env.LOCAL_DATABASE_URL,undefined,undefined,process.env.LOCAL_WHATSAPP_JSON,process.env.LOCAL_DELIVERY_PROOF_JSON);
