...
[Durable outbound WhatsApp](docs/architecture/whatsapp-outbound.md) stores logical message intents, separates acceptance from delivery, and provides controlled retries and recovery. [Notification automation](docs/architecture/notification-automation.md) resolves versioned Booking, Parcel, Route and final-mile policies into those intents without provider I/O. [Route-delay notifications](docs/architecture/route-delay-notifications.md) add frozen-membership, 20-item resumable fanout and rate-limited W19 reminders; #43 adds failed-attempt, committed-RTO and proof-aware completion updates with reservation-time stale suppression.
