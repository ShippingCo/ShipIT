...
| D05 | Concrete lease duration, retry/backoff, concurrency/polling, fairness, poison/redrive and consumer deduplication persistence mechanics | [ADR 0023](../adr/0023-durable-outbox-worker.md) implements PostgreSQL leases, fair scheduling, receipts and W44 redrive for review; #39/#40 retain provider/fanout decisions | #35 / outbox; #39 / messaging; #40 / consumer dedupe | #35 worker design, #39 processing, #40 persistence before respective implementations | #35, #39, #40, #41, #45 | PARTIAL: #35 implemented for review; downstream provider/fanout policies OPEN |
