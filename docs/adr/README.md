...
submission-status text is retained as historical evidence. ADR 0006 is submitted through
the issue #3 PR; these documents do not claim completed production features. Acceptance
